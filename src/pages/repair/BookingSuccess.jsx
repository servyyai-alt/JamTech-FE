...
const BookingSuccess = () => {
  ...
  return (
    <div className="container-px section-y mx-auto max-w-xl text-center">
      ...
      <h1 className="font-display text-3xl font-bold text-ink-900">Booking Confirmed!</h1>
      <p className="mt-2 text-gray-500">We've received your repair booking. Save your booking number to track progress.</p>
      ...
      {booking && (
        <div className="card mx-auto mt-6 max-w-sm space-y-2 p-6 text-left text-sm">
          <div className="flex justify-between"><span className="text-gray-500">Device</span><span className="font-medium">{booking.brand?.name} {booking.deviceModel?.name}</span></div>
          <div className="flex justify-between"><span className="text-gray-500">Repair</span><span className="font-medium">{booking.repairService?.name}</span></div>
          ...
          <div className="flex justify-between"><span className="text-gray-500">Price</span><span className="font-medium">€{booking.price}</span></div>
        </div>
      )}

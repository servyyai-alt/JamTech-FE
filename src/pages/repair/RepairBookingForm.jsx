            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              {needsAddress && (
                <>
                  ...
                  <div><label className="label">{t("city")} *</label><input className="input" onInput={(e) => e.target.value = e.target.value.replace(/[^\p{L}\s\-]/gu, "")} {...register("city", { required: needsAddress })} /></div>
                  <div><label className="label">{t("postalCode")} *</label><input className="input" onInput={(e) => e.target.value = e.target.value.replace(/[^0-9]/g, "")} {...register("postalCode", { required: needsAddress })} /></div>
                  <div><label className="label">{t("country")} *</label><input className="input" onInput={(e) => e.target.value = e.target.value.replace(/[^\p{L}\s]/gu, "")} {...register("country", { required: needsAddress })} /></div>
                </>
              )}
            </div>
          </div>

    ...
    <div className="container-px section-y mx-auto max-w-5xl">
      ...
      <div className="grid gap-10 md:grid-cols-2">
        <div className="space-y-6">
          <div className="flex items-start gap-3"><Mail className="text-primary-600" size={20} /><div><p className="font-semibold">{t("contact.emailLabel")}</p><p className="text-sm text-gray-500">{t("contact.emailValue")}</p></div></div>
          <div className="flex items-start gap-3"><Phone className="text-primary-600" size={20} /><div><p className="font-semibold">{t("contact.phoneLabel")}</p><p className="text-sm text-gray-500">{t("contact.phoneValue")}</p></div></div>
        ...
        <form onSubmit={handleSubmit} className="card space-y-4 p-6">
          <div><label className="label">{t("contact.form.name")}</label><input required className="input" /></div>
